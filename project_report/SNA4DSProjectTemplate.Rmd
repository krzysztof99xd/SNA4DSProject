...
From the network graph [[Appendix K]] it can be observed that there is a
...
higher number of communities corrresponds to a higher number of
isolates. In this research, the isolates represent countries that did
not receive top 3 votes from other countries. This simplification of the
voting process, might have an impact on the outcome due to
oversimplification.
