...
Therefore, it is apparent that considerable research has been conducted
on Eurovision voting patterns within the realm of social networks.
These studies encompass diverse aspects, yet there exists a research gap
in analyzing the impact of government systems or the influence of shared
language family on the voting network. 
...
Examining voting patterns within the Eurovision Song Contest in relation
to shared language families is crucial in understanding potential dynamics
that influence country-to-country preferences. Research on mutual
intelligibility among closely related European languages suggests that countries
with linguistic similarities may exhibit higher levels of understanding and
shared cultural nuances [@gooskens2018mutual]. Understanding the communicative
ease among countries with the same language family may unveil patterns of
mutual appreciation and shared cultural references that impact how votes
are cast in the Eurovision. Such insights can enhance our comprehension
of voting dynamics and contribute to a more nuanced understanding of the
Eurovision Song Contest as a cultural and linguistic phenomenon.
