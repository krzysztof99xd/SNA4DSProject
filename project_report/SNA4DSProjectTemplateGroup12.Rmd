...
Several other models have been run during this research. Some of them
scored either very low or did not converge in the given time frame. The
list of all the models that have been run together with model
specifications are presented in [APPENDIX K].
